<section class="content-header">
    <div class="row">
        ...
        <div class="col-sm-6">
            <div align="right">
                <?php if ($user->hasPermission('products_add')) : ?>
                    <div class="btn-group btn-group-sm">                    
                        <?php if ($user->hasPermission('products_add')) : ?>
                            <a href="<?php echo BASE_URL . 'products/add'; ?>" class="btn btn-success">Cadastrar Produto</a>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
...
<section class="content container-fluid">
            ...
            <form method="GET">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2" align="right">                        
                        <div class="btn-group btn-group-sm">
                            <a href="<?php echo BASE_URL . 'products'; ?>" class="btn btn-secondary"><i class="fas fa-eraser"></i> Limpar Filtro</a>
                        </div>                      
                    </div>
    ...
    <div class="shadow p-3 mb-5 bg-white rounded table-responsive">
        <div class="box-header">
            <h6 class="box-title" align="center">Gerenciamento de Produtos</h6>         
        </div>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                    <div class="btn-group">
                        <?php if ($user->hasPermission('products_edit')) : ?>
                        <a href="<?php echo BASE_URL . 'products/edit/' . $item['id']; ?>" class="btn btn-xs btn-warning">Editar</a>
                        <?php endif; ?>
                        <?php if ($user->hasPermission('products_del')) : ?>
        ...
        <hr/>
                ...
                echo BASE_URL . 'products?' . http_build_query($items);
                ?>">
