...
<section class="content container-fluid">
    ...
    <form method="POST" action="<?php echo BASE_URL; ?>products/edit_action">
        ...
        <div class="shadow p-3 mb-5 bg-white rounded">			
            ...
            <div  align="right">
                <a href="<?php echo BASE_URL.'products'; ?>" class="btn btn-primary"><i class="nav-icon fas fa-reply"></i> Voltar</a>
